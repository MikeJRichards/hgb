  ...
  <>
    <div className="hero-section centered">
      <div data-w-id="e464d218-f801-55d1-1f50-7da00b5bfb8f" className="container w-container">
        ...
        <div data-ix="fade-in-bottom-page-loads" className="div-block"><a href="/swap"
    ...
    <div className="hero-section">
      <div data-w-id="46337e64-666d-e1fe-d1ef-31271e61eab4" className="container-copy w-container">
        <div className="w-layout-hflex flex-block-2">
          ...
          With HomeVestors DAO, you can invest in property through Loan Non-fungible Tokens (LNFTs), which represent £1000 of equity within a property, without granting ownership of future capital Homereciation.</p>
        </div>
      </div>
    </div>
    <div className="section accent">
      <div className="w-container">
        ...
        <div><a href="/swap" className="hollow-button all-caps">swap</a></div>
      </div>
    </div>
